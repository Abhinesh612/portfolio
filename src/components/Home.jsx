        ...
        <div name='home' className='bg-[#0a192f] h-screen w-full'>
            ...
            <div className='max-w-[980] ml-[50px] mx-auto px-8 flex flex-col justify-center h-full'>
                ...
                <p className='py-4 max-w-[700px] text-amber-100'>
                    I'm Abhinesh Sharma. I am collage student from India who loves Computer and Mathamatics. But the most inportant I am a man of culture.
                </p>
                <div> <a href='https://github.com/Abhinesh612' target='_blank'>
                    <button className='test-amber-100 group px-6 py-3 my-2 flex items-center hover:bg-rose-400 bg-amber-400'>
                        Github
